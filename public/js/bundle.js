...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2VidGVzdC1wYSIsImEiOiJja2U4bDIxamoxbnViMnJsNnpmYWNlbG8zIn0.WCCUuSN7nebAujC9T6cZMA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/webtest-pa/cke8o32sc3mq91anzo60xdem4',
    scrollZoom: false //   center: [-118.113492, 34.111745],
    //   zoom: 4,
    //   interactive: false
...
var stripe = Stripe('pk_test_51HKgkXDl1EedCrNzLMfZKGhBqmpeiyltWrwQXRJVAi8ydiJ1IsUgcCsBsB3AP72yqwBT6VgBhyoT9uX7a9QTgUzu00qcry7HCx');
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    var _iterator = _createForOfIteratorHelper(rbs),
        _step;
